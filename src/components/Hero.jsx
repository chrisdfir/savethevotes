    ...
    <header className="relative overflow-hidden">
      ...
      >
        ...
        >
          ...
          not it passes, <em className="text-text font-normal">be ready</em>.
          Find out exactly what documents you need and how to get them in your
          state.
        </motion.p>
        ...
        >
          <StatusBadge
            active={true}
            label="Passed House Feb 11, 2026 (218-213)"
          />

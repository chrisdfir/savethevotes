  ...
  return (
    ...
    >
      ...
      >
        ...
        <p className="text-text-secondary leading-relaxed">
          Nearly <a href="https://www.pewresearch.org/short-reads/2023/09/07/about-eight-in-ten-women-in-opposite-sex-marriages-say-they-took-their-husbands-last-name/" target="_blank" rel="noopener noreferrer" className="text-danger-light hover:underline">8 in 10 married women</a> in the U.S. change their surname. The
